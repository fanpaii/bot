...
from utils.notification_service import notification_service, get_notification_service, init_notification_service
    ...
    if protocol_version == "855":
        ...
        try:
            ...
            if (client2_path / "__init__.py").exists():
                ...
                bot = WechatAPIClient("127.0.0.1", api_config.get("port", 9000))
        except Exception as e:
